...
import com.oracle.myblog.xml.blog.UserDetailXmlParser;
import com.oracle.myblog.xml.blog.UserListXmlParser;
...
public class UserHelper {
	...
	public static Users GetUserDetail(String userName) {
		String url = ConfigUtil.URL_GET_BLOG_LIST_BY_AUTHOR
	...
	public static ArrayList<Users> GetUserList(String q) {
		String url = ConfigUtil.URL_USER_SEARCH_AUTHOR_LIST
	...
	public static List<Users> GetTopUserList(int pageIndex){
		String url=ConfigUtil.URL_RECOMMEND_USER_LIST.replace("{pageIndex}",String.valueOf(pageIndex))
					.replace("{pageSize}",String.valueOf(ConfigUtil.NUM_RECOMMEND_USER));
		String dataString = NetHelper.getContentFromUrl(url);
